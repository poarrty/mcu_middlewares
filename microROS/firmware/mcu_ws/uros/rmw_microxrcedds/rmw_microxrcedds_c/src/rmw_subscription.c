  ...
  const rmw_subscription_options_t * subscription_options)
{
  ...
  rmw_uxrce_subscription_t *myData = NULL;
  ...
  if (!node) {
    ...
    if (custom_subscription->topic == NULL) {
        RMW_SET_ERROR_MSG("custom_subscription->topic == NULL\r\n");
      goto fail;
    }
...
fail:
#ifdef RMW_UXRCE_FIXBUG
    myData = (rmw_uxrce_subscription_t *)rmw_subscription->data;
    if ((myData != NULL) && (myData->topic != NULL))
    {
        rmw_uxrce_fini_topic_memory(myData->topic);
    }
#endif
