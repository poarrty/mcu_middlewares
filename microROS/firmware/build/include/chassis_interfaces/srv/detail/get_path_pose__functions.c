...
#include "chassis_interfaces/srv/detail/get_path_pose__functions.h"
...
chassis_interfaces__srv__GetPathPose_Request__init(chassis_interfaces__srv__GetPathPose_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->map_id)) {
    chassis_interfaces__srv__GetPathPose_Request__fini(msg);
    return false;
  }
  // task_id
...
{
  chassis_interfaces__srv__GetPathPose_Request * msg = (chassis_interfaces__srv__GetPathPose_Request *)malloc(sizeof(chassis_interfaces__srv__GetPathPose_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chassis_interfaces__srv__GetPathPose_Request));
  bool success = chassis_interfaces__srv__GetPathPose_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
chassis_interfaces__srv__GetPathPose_Request__Sequence__init(chassis_interfaces__srv__GetPathPose_Request__Sequence * array, size_t size)
{
  ...
  chassis_interfaces__srv__GetPathPose_Request * data = NULL;
  if (size) {
    data = (chassis_interfaces__srv__GetPathPose_Request *)calloc(size, sizeof(chassis_interfaces__srv__GetPathPose_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chassis_interfaces__srv__GetPathPose_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        chassis_interfaces__srv__GetPathPose_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
chassis_interfaces__srv__GetPathPose_Request__Sequence__fini(chassis_interfaces__srv__GetPathPose_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      chassis_interfaces__srv__GetPathPose_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  chassis_interfaces__srv__GetPathPose_Request__Sequence * array = (chassis_interfaces__srv__GetPathPose_Request__Sequence *)malloc(sizeof(chassis_interfaces__srv__GetPathPose_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = chassis_interfaces__srv__GetPathPose_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    chassis_interfaces__srv__GetPathPose_Request__Sequence__fini(array);
  }
  free(array);
}
...
chassis_interfaces__srv__GetPathPose_Response__init(chassis_interfaces__srv__GetPathPose_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->msg)) {
    chassis_interfaces__srv__GetPathPose_Response__fini(msg);
    return false;
  }
  // vec_coordinate
...
{
  chassis_interfaces__srv__GetPathPose_Response * msg = (chassis_interfaces__srv__GetPathPose_Response *)malloc(sizeof(chassis_interfaces__srv__GetPathPose_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chassis_interfaces__srv__GetPathPose_Response));
  bool success = chassis_interfaces__srv__GetPathPose_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
chassis_interfaces__srv__GetPathPose_Response__Sequence__init(chassis_interfaces__srv__GetPathPose_Response__Sequence * array, size_t size)
{
  ...
  chassis_interfaces__srv__GetPathPose_Response * data = NULL;
  if (size) {
    data = (chassis_interfaces__srv__GetPathPose_Response *)calloc(size, sizeof(chassis_interfaces__srv__GetPathPose_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chassis_interfaces__srv__GetPathPose_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        chassis_interfaces__srv__GetPathPose_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
chassis_interfaces__srv__GetPathPose_Response__Sequence__fini(chassis_interfaces__srv__GetPathPose_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      chassis_interfaces__srv__GetPathPose_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  chassis_interfaces__srv__GetPathPose_Response__Sequence * array = (chassis_interfaces__srv__GetPathPose_Response__Sequence *)malloc(sizeof(chassis_interfaces__srv__GetPathPose_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = chassis_interfaces__srv__GetPathPose_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    chassis_interfaces__srv__GetPathPose_Response__Sequence__fini(array);
  }
  free(array);
}
