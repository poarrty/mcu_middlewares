...
#ifndef CHASSIS_INTERFACES__SRV__DETAIL__PILE_REQUEST__FUNCTIONS_H_
#define CHASSIS_INTERFACES__SRV__DETAIL__PILE_REQUEST__FUNCTIONS_H_
...
#include "chassis_interfaces/srv/detail/pile_request__struct.h"

/// Initialize srv/PileRequest message.
/**
...
/// Finalize srv/PileRequest message.
/**
...
/// Create srv/PileRequest message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chassis_interfaces__srv__PileRequest_Request__init().
...
/// Destroy srv/PileRequest message.
/**
 * It calls
 * chassis_interfaces__srv__PileRequest_Request__fini()
...
/// Initialize array of srv/PileRequest messages.
/**
...
/// Finalize array of srv/PileRequest messages.
/**
 * It calls
 * chassis_interfaces__srv__PileRequest_Request__fini()
...
/// Create array of srv/PileRequest messages.
/**
 * It allocates the memory for the array and calls
 * chassis_interfaces__srv__PileRequest_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PileRequest messages.
/**
 * It calls
 * chassis_interfaces__srv__PileRequest_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chassis_interfaces__srv__PileRequest_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chassis_interfaces
...
/**
 * It calls
 * chassis_interfaces__srv__PileRequest_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chassis_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chassis_interfaces__srv__PileRequest_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chassis_interfaces
...
/**
 * It calls
 * chassis_interfaces__srv__PileRequest_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHASSIS_INTERFACES__SRV__DETAIL__PILE_REQUEST__FUNCTIONS_H_
