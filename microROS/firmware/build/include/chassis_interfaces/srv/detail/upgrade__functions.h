...
#ifndef CHASSIS_INTERFACES__SRV__DETAIL__UPGRADE__FUNCTIONS_H_
#define CHASSIS_INTERFACES__SRV__DETAIL__UPGRADE__FUNCTIONS_H_
...
#include "chassis_interfaces/srv/detail/upgrade__struct.h"

/// Initialize srv/Upgrade message.
/**
...
/// Create srv/Upgrade message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chassis_interfaces__srv__Upgrade_Request__init().
...
/// Destroy srv/Upgrade message.
/**
 * It calls
 * chassis_interfaces__srv__Upgrade_Request__fini()
...
/// Initialize array of srv/Upgrade messages.
/**
...
/// Finalize array of srv/Upgrade messages.
/**
 * It calls
 * chassis_interfaces__srv__Upgrade_Request__fini()
...
/// Create array of srv/Upgrade messages.
/**
 * It allocates the memory for the array and calls
 * chassis_interfaces__srv__Upgrade_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Upgrade messages.
/**
 * It calls
 * chassis_interfaces__srv__Upgrade_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chassis_interfaces__srv__Upgrade_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chassis_interfaces
...
/**
 * It calls
 * chassis_interfaces__srv__Upgrade_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chassis_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chassis_interfaces__srv__Upgrade_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chassis_interfaces
...
/**
 * It calls
 * chassis_interfaces__srv__Upgrade_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHASSIS_INTERFACES__SRV__DETAIL__UPGRADE__FUNCTIONS_H_
