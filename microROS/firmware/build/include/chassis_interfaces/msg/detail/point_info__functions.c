...
chassis_interfaces__msg__PointInfo__init(chassis_interfaces__msg__PointInfo * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->point_id)) {
    chassis_interfaces__msg__PointInfo__fini(msg);
    return false;
  }
  // point_type
...
{
  chassis_interfaces__msg__PointInfo * msg = (chassis_interfaces__msg__PointInfo *)malloc(sizeof(chassis_interfaces__msg__PointInfo));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chassis_interfaces__msg__PointInfo));
  bool success = chassis_interfaces__msg__PointInfo__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
chassis_interfaces__msg__PointInfo__Sequence__init(chassis_interfaces__msg__PointInfo__Sequence * array, size_t size)
{
  ...
  chassis_interfaces__msg__PointInfo * data = NULL;
  if (size) {
    data = (chassis_interfaces__msg__PointInfo *)calloc(size, sizeof(chassis_interfaces__msg__PointInfo));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chassis_interfaces__msg__PointInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        chassis_interfaces__msg__PointInfo__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
chassis_interfaces__msg__PointInfo__Sequence__fini(chassis_interfaces__msg__PointInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      chassis_interfaces__msg__PointInfo__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  chassis_interfaces__msg__PointInfo__Sequence * array = (chassis_interfaces__msg__PointInfo__Sequence *)malloc(sizeof(chassis_interfaces__msg__PointInfo__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = chassis_interfaces__msg__PointInfo__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    chassis_interfaces__msg__PointInfo__Sequence__fini(array);
  }
  free(array);
}
